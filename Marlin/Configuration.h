...
#define STRING_CONFIG_H_AUTHOR "(Thomas Gerbier, Ender-3_bltouch_v1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Rossinante"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -13, 0 }
